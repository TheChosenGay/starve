...
func TestTestOBBOBB(t *testing.T) {
	a := boxOBB(Vec3{X: 0, Y: 0, Z: 0}, Vec3{X: 2, Y: 2, Z: 2})

	// 重叠
	if !TestOBBOBB(a, boxOBB(Vec3{X: 1.5, Y: 0, Z: 0}, Vec3{X: 3.5, Y: 2, Z: 2})) {
		t.Fatal("overlapping boxes should intersect")
	}
	// 相切（d == rA+rB）
	if !TestOBBOBB(a, boxOBB(Vec3{X: 2, Y: 0, Z: 0}, Vec3{X: 4, Y: 2, Z: 2})) {
		t.Fatal("boxes touching at a face should intersect")
	}
	// 分离
	if TestOBBOBB(a, boxOBB(Vec3{X: 3, Y: 0, Z: 0}, Vec3{X: 5, Y: 2, Z: 2})) {
	...
	if TestOBBOBB(rot, boxOBB(Vec3{X: 3, Y: -0.5, Z: -0.5}, Vec3{X: 4, Y: 0.5, Z: 0.5})) {
		t.Fatal("rotated box should be separated when centers are 3.5 apart (reach ≈1.914)")
	}
	// 中心距 1.5 < 1.914 => 相交
	if !TestOBBOBB(rot, boxOBB(Vec3{X: 1.0, Y: -0.5, Z: -0.5}, Vec3{X: 2.0, Y: 0.5, Z: 0.5})) {
...
func TestContactOBBOBB(t *testing.T) {
	a := boxOBB(Vec3{X: 0, Y: 0, Z: 0}, Vec3{X: 2, Y: 2, Z: 2})
	b := boxOBB(Vec3{X: 1.5, Y: 0, Z: 0}, Vec3{X: 3.5, Y: 2, Z: 2})
	...
	ca, _ := ContactAABBAABB(
		AABB{Min: Vec3{X: 0, Y: 0, Z: 0}, Max: Vec3{X: 2, Y: 2, Z: 2}},
		AABB{Min: Vec3{X: 1.5, Y: 0, Z: 0}, Max: Vec3{X: 3.5, Y: 2, Z: 2}},
	)
	...
	// 分离
	if _, ok := ContactOBBOBB(a, boxOBB(Vec3{X: 3, Y: 0, Z: 0}, Vec3{X: 5, Y: 2, Z: 2})); ok {
		t.Fatal("separated boxes should not be in contact")
	}
}

func TestClosestPtSegmentOBB(t *testing.T) {
	box := boxOBB(Vec3{X: -1, Y: -1, Z: -1}, Vec3{X: 1, Y: 1, Z: 1})
	cases := []struct {
		name     string
		a, b     Vec3
		wantDist float64
	}{
		{"侧面外", Vec3{X: -4, Y: 0, Z: 0}, Vec3{X: -2, Y: 0, Z: 0}, 1},          // 到 x=-1 面距离 1
		{"正上方", Vec3{X: 0, Y: 5, Z: 0}, Vec3{X: 0, Y: 5, Z: 0.5}, 4},          // 到 y=1 面距离 4
		{"穿过盒", Vec3{X: -3, Y: 0, Z: 0}, Vec3{X: 3, Y: 0, Z: 0}, 0},           // 穿过 => 距离 0
		{"斜穿", Vec3{X: -3, Y: -3, Z: 0}, Vec3{X: 3, Y: 3, Z: 0}, 0},           // 过原点 => 0
		{"角外", Vec3{X: 3, Y: 3, Z: 3}, Vec3{X: 5, Y: 5, Z: 5}, math.Sqrt(12)}, // 到角点 (1,1,1)
	}
	...
	p, q, _ := ClosestPtSegmentOBB(Vec3{X: -4, Y: 0, Z: 0}, Vec3{X: -2, Y: 0, Z: 0}, box)
	if !vecAlmostEq(p, Vec3{X: -2, Y: 0, Z: 0}) || !vecAlmostEq(q, Vec3{X: -1, Y: 0, Z: 0}) {
...
func TestBladeVsBody(t *testing.T) {
	...
	body := Capsule{A: Vec3{X: 1.2, Y: 0, Z: 0}, B: Vec3{X: 1.2, Y: 1.8, Z: 0}, R: 0.4}
	...
	bodyFar := Capsule{A: Vec3{X: 3.5, Y: 0, Z: 0}, B: Vec3{X: 3.5, Y: 1.8, Z: 0}, R: 0.4}
